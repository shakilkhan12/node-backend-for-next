...
exports.default = (function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, user, username, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                user = jsonwebtoken_1.default.verify(token, process.env.JWT_SECRET).user;
                return [4 /*yield*/, User_1.default.findOne({ username: user.username })];
            case 1:
                username = _a.sent();
